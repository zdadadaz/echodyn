...
# +
# model = generate_model(**{'model_depth':50, 'pretrain' : './../../../3D-ResNets-PyTorch/pretrain_model/r2p1d50_K_200ep.pth', 'funetune_size':1,'n_input_channels':3})
# print(model.fc.bias.data[0])
